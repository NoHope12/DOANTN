...
$this->dt_form_begin(1, 4, $title . ' ' . FSText::_('Đối tác'), 'fa-edit', 1, 'col-md-8', 1);
TemplateHelper::dt_edit_text(FSText:: _('Tên đối tác'), 'title', @$data->title);
...
//TemplateHelper::dt_edit_selectbox(FSText::_('Ứng dụng'), 'application', @$data->application, 0, $application, $field_value = 'id', $field_label = 'name', $size = 1, 0);
//TemplateHelper::dt_edit_selectbox(FSText::_('Đơn vị kinh doanh'),'business',@$data -> business,0,$business,$field_value = 'id', $field_label='name',$size = 1,0,1);
//TemplateHelper::dt_edit_selectbox(FSText::_('Khu vực'),'region',@$data -> region,0,$region,$field_value = 'id', $field_label='name',$size = 1,0,1);
...
TemplateHelper::dt_edit_text(FSText :: _('Trụ sở chính'),'address',@$data -> address,'',100,2,0,'','','col-sm-3','col-sm-9');
TemplateHelper::dt_edit_text(FSText :: _('Hotline'),'hotline',@$data -> hotline,'',100,1,0,'','','col-sm-3','col-sm-9');
TemplateHelper::dt_edit_text(FSText :: _('Link partners'),'link_partner',@$data -> link_partner,'',100,1,0,'','','col-sm-3','col-sm-9');
