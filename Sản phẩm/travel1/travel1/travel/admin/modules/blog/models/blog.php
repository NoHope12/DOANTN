<?php
class blogModelsblog extends FSModels
{
	var $limit;
	var $prefix;
	function __construct()
	{
		...
		//$this -> table_types = 'fs_blog_types';
		...
		$this->table_category_name = FSTable_ad::_('fs_blog_categories');
		$this->table_name = FSTable_ad::_('fs_blog');
