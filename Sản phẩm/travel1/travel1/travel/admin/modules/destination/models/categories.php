<?php 
	class destinationModelsCategories extends ModelsCategories
	{
		function __construct()
		{
			
			$this -> table_items = FSTable_ad::_('fs_destination');
			$this -> table_name = FSTable_ad::_('fs_destination_categories');
			$this -> check_alias = 1;
