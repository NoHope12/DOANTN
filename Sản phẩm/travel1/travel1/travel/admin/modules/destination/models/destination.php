<?php
class DestinationModelsDestination extends FSModels
{
	var $limit;
	var $prefix;
	function __construct()
	{
		...
		//$this -> table_types = 'fs_destination_types';
		...
		$this->table_category_name = FSTable_ad::_('fs_destination_categories');
		$this->table_name = FSTable_ad::_('fs_destination');
		...
		$cmonth = date('m');
		//$cday = date('d');
		$this->img_folder = 'images/detination/' . $cyear . '/' . $cmonth;
		$this->check_alias = 0;
