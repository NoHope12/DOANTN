...
// TemplateHelper::dt_edit_image(FSText :: _('image_banner'),'image_banner',URL_ROOT.str_replace('/original/','/original/',@$data->image_banner));
...
TemplateHelper::dt_edit_text(FSText::_('Địa điểm'), 'dia_diem', @$data->dia_diem, '', 100, 1, 0, '', '', 'col-sm-3', 'col-sm-9');
TemplateHelper::dt_edit_text(FSText::_('Loại Tour'), 'loai', @$data->loai, '', 100, 1, 0, '', '', 'col-sm-3', 'col-sm-9');
TemplateHelper::dt_edit_text(FSText::_('Số người'), 'people', @$data->people, '', 100, 1, 0, '', '', 'col-sm-3', 'col-sm-9');
TemplateHelper::dt_edit_text(FSText::_('Giá Cũ'), 'cost_old', @$data->cost_old, '', 100, 1, 0, '', '', 'col-sm-3', 'col-sm-9');
TemplateHelper::dt_edit_text(FSText::_('Giá Mới'), 'cost_new', @$data->cost_new, '', 100, 1, 0, '', '', 'col-sm-3', 'col-sm-9');
TemplateHelper::dt_edit_text(FSText::_('Đánh Giá'), 'review', @$data->review, '', 100, 1, 0, '', '', 'col-sm-3', 'col-sm-9');
...
// TemplateHelper::dt_checkbox(FSText::_('Ba cột'),'check_right',@$data -> check_right,0,'','','','col-sm-4','col-sm-8');
// TemplateHelper::dt_checkbox(FSText::_('Share'),'share',@$data -> share,0,'','','','col-sm-4','col-sm-8');
...
$this->dt_form_begin(1, 2, FSText::_('phân loại'), 'fa-unlock', 1, 'col-md-4 fl-right');
// TemplateHelper::dt_checkbox(FSText::_('Hiển thị trang chủ'),'show_in_homepage',@$data -> show_in_homepage,0,'','','','col-sm-4','col-sm-8');
// TemplateHelper::dt_checkbox(FSText::_('Ba cột'),'check_right',@$data -> check_right,0,'','','','col-sm-4','col-sm-8');
// TemplateHelper::dt_checkbox(FSText::_('Share'),'share',@$data -> share,0,'','','','col-sm-4','col-sm-8');
//TemplateHelper::dt_checkbox(FSText::_('Tin nổi bật'),'is_hot',@$data -> is_hot,0,'','','','col-sm-4','col-sm-8');
...
//TemplateHelper::dt_checkbox(FSText::_('Tin video'),'is_video',@$data -> is_video,0,'','','','col-sm-4','col-sm-8');
//TemplateHelper::dt_checkbox(FSText::_('Tin mới'),'is_new',@$data -> is_new,0,'','','','col-sm-4','col-sm-8');
TemplateHelper::dt_edit_text(FSText::_('Phân Loại'), 'type_price', @$data->type_price, '', 100, 1, 0, '', '', 'col-sm-3', 'col-sm-9');
$this->dt_form_end_col(); // END: col-2
...
$this->dt_form_end_col(); // END: col-4
$this->dt_form_begin(1, 4, FSText::_('Lịch trình'), 'fa-info', 1, 'col-md-8');
TemplateHelper::dt_edit_text(FSText::_(''), 'lich_trinh', @$data->lich_trinh, '', 650, 450, 1, '', '', 'col-sm-2', 'col-sm-12');
$this->dt_form_end_col(); // END: col-4
$this->dt_form_begin(1, 4, FSText::_('Chỗ ở'), 'fa-info', 1, 'col-md-8');
TemplateHelper::dt_edit_text(FSText::_(''), 'cho_o', @$data->cho_o, '', 650, 450, 1, '', '', 'col-sm-2', 'col-sm-12');
$this->dt_form_end_col(); // END: col-4
$this->dt_form_begin(1, 4, FSText::_('FAQ'), 'fa-info', 1, 'col-md-8');
TemplateHelper::dt_edit_text(FSText::_(''), 'faq', @$data->faq, '', 650, 450, 1, '', '', 'col-sm-2', 'col-sm-12');
$this->dt_form_end_col(); // END: col-4
$this->dt_form_begin(1, 4, FSText::_('Image'), 'fa-info', 1, 'col-md-8');
TemplateHelper::dt_edit_text(FSText::_(''), 'list_img', @$data->list_img, '', 650, 450, 1, '', '', 'col-sm-2', 'col-sm-12');
$this->dt_form_end_col(); // END: col-4
