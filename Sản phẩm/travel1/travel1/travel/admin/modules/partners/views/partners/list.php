...
//	$fitler_config['text'][] = $text_to_date;
	//	CONFIG	
	$list_config = array();
	$list_config[] = array('title'=>'Tiêu đề tin','field'=>'title','ordering'=> 1,'align'=>'left', 'type'=>'edit_text','col_width' => '30%','link'=>'index.php?module=news&view=news&ccode=ccode&code=code&id=id&Itemid=4','arr_params'=>array('size'=> 10));
