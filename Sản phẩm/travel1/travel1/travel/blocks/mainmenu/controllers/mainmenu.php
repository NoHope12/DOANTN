<?php
	...
	include PATH_BASE.'blocks/mainmenu/models/mainmenu.php';
...
//			echo $style;die;
			...
			if($style == 'megamenu' || $style == 'megamenu_moblie' || $style == 'megamenu_bottom' || $style == 'horizon_newsmenu' || $style == 'megamenu_benni' || $style == 'left'){
...
//var_dump($list);
			include PATH_BASE.'blocks/mainmenu/views/mainmenu/'.$style.'.php';
	...
	/*
		...
		function get_record_by_id($id_cur,$tab_s){

		    $model = new MainMenuBModelsMainMenu;

            $result = $model->get_list2($id_cur,$tab_s);
