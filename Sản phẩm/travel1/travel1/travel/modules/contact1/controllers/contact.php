...
class Contact1ControllersContact extends FSControllers
{
	function display()
	{
		// call models
	...
	function save()
	{
		...
		if ($rs == 1) {
			...
			$model->_add($row, 'fs_contact');
			 setRedirect(FSRoute::_('index.php?module=home&view=home'), FSText::_('Cảm ơn bạn đã gửi thông tin liên hệ!'), 'success');
		} else {
