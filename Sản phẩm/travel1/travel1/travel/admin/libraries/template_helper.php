...
//				$compare = $value;
    ...
    public static function dt_edit_choose_file($title, $name, $value = '', $comment = '', $class_col1 = 'col-md-3', $class_col2 = 'col-md-9') {
        // phan quyen theo field
        $module = FSInput::get('module');
        $view = FSInput::get('view', $module);
        $permission = FSSecurity::check_permission_field($module, $view, $name);
        ...
        <a id="btn-video-'.$name.'" style="color: white !important; margin-top: 10px" class="btn btn-primary" href="javascript:void(0)">Chọn tệp</a>
        ';
        
        $html .= '
        <script type="text/javascript">
            $("#btn-video-'.$name.'").click(function () {
