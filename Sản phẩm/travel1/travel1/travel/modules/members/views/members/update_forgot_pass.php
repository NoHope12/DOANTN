...
?>
<div id="contact" class="container container-white container-member">
            ...
            <div class="col-lg-6">
                <form id="frmLogin" action="<?php echo FSRoute::_('index.php?module=members&view=members&task=do_update_forgot_pass'); ?>" method="post">
                    <div class="form-group">
                        <input  type="text" id="activated_code" name="activated_code" value="" placeholder="Mã bảo mật" />
                    </div><!--end: .bound-input-->
                    <div class="form-group">
                        <input type="password" id="password" name="password" value="" placeholder="Nhập mật khẩu mới" />
                    </div><!--end: .bound-input-->
                    <div class="form-group">
                        <input type="password" id="repassword" name="repassword" value="" placeholder="Xác nhận mật khẩu mới" />
                    </div><!--end: .bound-input-->
                    <div class="group-button">
                        <a class="button login" onclick="validateForgotUpdate();" href="javascript:void(0);" title="Đổi mật khẩu">Đổi mật khẩu</a>
                    </div><!--end: .bound-input-->
