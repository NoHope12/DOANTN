<?php
class tourModelstour extends FSModels
{
	var $limit;
	var $prefix;
	function __construct()
	{
		...
		//$this -> table_types = 'fs_tour_types';
		...
		$this->table_category_name = FSTable_ad::_('fs_tour_categories');
		$this->table_name = FSTable_ad::_('fs_tour');
