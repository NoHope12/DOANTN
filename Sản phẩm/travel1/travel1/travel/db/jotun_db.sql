/*
 ...
 Source Schema         : jotun_db

 Target Server Type    : MySQL
 Target Server Version : 50724
 File Encoding         : 65001

 Date: 24/10/2022 12:04:45
*/
...
CREATE TABLE `fs_address`  (
  ...
  `bitrix_id` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `fs_blocks`  (
  ...
  `hide_admin` tinyint(4) NULL DEFAULT NULL,
...
CREATE TABLE `fs_config`  (
  ...
  `published` tinyint(4) NULL DEFAULT NULL COMMENT 'thông số giành cho google',
  `is_ga` tinyint(4) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `fs_config` VALUES (1, 'site_name', 'Site Name', 'Jotun', 'text', 1, 1, NULL, 1, NULL);
INSERT INTO `fs_config` VALUES (2, 'title', 'Title', 'Jotun', 'text', 1, 1, NULL, 2, NULL);
INSERT INTO `fs_config` VALUES (3, 'meta_des', 'Meta des', 'Jotun', 'text', 1, 1, NULL, 3, NULL);
INSERT INTO `fs_config` VALUES (4, 'meta_key', 'Meta key', 'Jotun', 'text', 1, 1, NULL, 4, NULL);
INSERT INTO `fs_config` VALUES (5, 'admin_name', 'Admin name', 'Jotun', 'text', 0, 1, NULL, 5, NULL);
INSERT INTO `fs_config` VALUES (6, 'admin_email', 'Admin email', 'manhlinh@finalstyle.com', 'text', 1, 1, NULL, 6, NULL);
INSERT INTO `fs_config` VALUES (7, 'main_title', 'Đuôi tiêu đề', 'Jotun', 'text', 1, 1, NULL, 7, NULL);
INSERT INTO `fs_config` VALUES (8, 'main_meta_key', 'Thẻ meta_key chính', 'Jotun', 'text', 1, 1, NULL, 8, NULL);
INSERT INTO `fs_config` VALUES (9, 'main_meta_des', 'Thẻ meta_des chính', 'Jotun', 'text', 1, 1, NULL, 9, NULL);
...
INSERT INTO `fs_config` VALUES (11, 'the_le', 'Thể Lệ', '<h1>Thể lệ chi tiết</h1>\r\n\r\n<p><strong>1. Đối tượng:</strong> Tất cả kh&aacute;ch h&agrave;ng truy cập trang</p>\r\n\r\n<p><strong>2. Cơ cấu giải thưởng </strong></p>\r\n\r\n<ul>\r\n	<li>Một giải đặc biệt: Điện thoại iPhone 14 Pro Max</li>\r\n	<li>H&agrave;ng ng&agrave;n giải thưởng thẻ nạp điện thoại trị gi&aacute; 20,000 đồng v&agrave; 50,000 đồng</li>\r\n	<li>Tổng gi&aacute; trị giải thưởng l&ecirc;n đến 100 triệu đồng</li>\r\n</ul>\r\n\r\n<p><strong>3. Thể lệ chương tr&igrave;nh:</strong></p>\r\n\r\n<ul>\r\n	<li>Kh&aacute;ch h&agrave;ng truy cập trang web: majesticsangtrong.jotun.vn</li>\r\n	<li>Điền th&ocirc;ng tin người chơi v&agrave; tiến h&agrave;nh chơi. Lưu &yacute; th&ocirc;ng tin kh&aacute;ch h&agrave;ng cung cấp sẽ l&agrave; căn cứ để Jotun sử dụng để quay thưởng t&igrave;m ra chủ nh&acirc;n sở hữu điện thoại IPhone 14 Pro Max sau khi kết th&uacute;c chương tr&igrave;nh</li>\r\n	<li>Sau khi ho&agrave;n th&agrave;nh lượt chơi của m&igrave;nh, kh&aacute;ch h&agrave;ng nhận ngay một lượt lật mở hộp qu&agrave; để nhận về h&agrave;ng trăm thẻ nạp điện thoại mệnh gi&aacute; 20,000 đồng v&agrave; 50,0000 đồng</li>\r\n	<li>Kh&ocirc;ng &aacute;p dụng cho tất cả nh&acirc;n vi&ecirc;n của Jotun v&agrave; nh&acirc;n vi&ecirc;n của Nh&agrave; cung cấp đang cung cấp dịch vụ với Jotun.</li>\r\n</ul>\r\n\r\n<p>T&iacute;nh hợp lệ của bằng chứng x&aacute;c định tr&uacute;ng thưởng:</p>\r\n\r\n<ul>\r\n	<li>Người tr&uacute;ng thưởng phải đảm bảo cung cấp đầy đủ th&ocirc;ng tin bao gồm Họ t&ecirc;n v&agrave; SDT.</li>\r\n	<li>Người chơi khi tham gia phải đảm bảo cung cấp đ&uacute;ng v&agrave; đầy đủ th&ocirc;ng tin họ t&ecirc;n v&agrave; SDT (SDT được đăng k&yacute; bằng đ&uacute;ng th&ocirc;ng tin họ t&ecirc;n tr&ecirc;n CMND m&agrave; kh&aacute;ch h&agrave;ng cung cấp)</li>\r\n</ul>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>4. Thời gian, địa điểm v&agrave; c&aacute;ch thức x&aacute;c định tr&uacute;ng thưởng:</strong></p>\r\n\r\n<ul>\r\n	<li>Thời gian tham gia: 11/11/2022 &ndash; 30/11/2022</li>\r\n	<li>Thời gian r&uacute;t thăm: 9h ng&agrave;y 01/12/2022</li>\r\n</ul>\r\n\r\n<p><strong>C&aacute;ch thức thực hiện:</strong></p>\r\n\r\n<ul>\r\n	<li>Giải đặc biệt tr&uacute;ng điện thoại iPhone 14 Pro Max được x&aacute;c định người tr&uacute;ng giải bằng c&aacute;ch quay số ngẫu nhi&ecirc;n dựa tr&ecirc;n th&ocirc;ng tin kh&aacute;ch h&agrave;ng cung cấp</li>\r\n	<li>Trong trường hợp, SĐT tr&uacute;ng thưởng kh&ocirc;ng hợp lệ, Jotun sẽ tiến h&agrave;nh quay số lại cho đến khi chọn được người tr&uacute;ng thưởng hợp lệ.</li>\r\n</ul>\r\n\r\n<p><strong>Trao giải:</strong></p>\r\n\r\n<ul>\r\n	<li>Đối với giải ng&agrave;y: Thẻ nạp điện thoại mệnh gi&aacute; 50,000 đồng v&agrave; 20,000 đồng sẽ được gửi trực tiếp cho kh&aacute;ch h&agrave;ng ngay sau khi kh&aacute;ch h&agrave;ng tr&uacute;ng tlệ của phiếu r&uacute;t thăm v&agrave; th&ocirc;ng tin c&aacute; nh&acirc;n của người thụ hưởng</li>\r\n	<li>Đối với giải đặc biệt &ndash; 01 điện thoại IPhone 14 Pro Max, ban tổ chức sẽ li&ecirc;n hệ với người tr&uacute;ng thưởng qua điện thoại để x&aacute;c nhận t&iacute;nh hợp lệ. Trường hợp kh&ocirc;ng liện hệ được với ngưới tr&uacute;ng trong v&ograve;ng 7 ng&agrave;y l&agrave;m việc, Jotun sẽ hủy kết quả&nbsp;</li>\r\n	<li>Khi nhận giải, Kh&aacute;ch h&agrave;ng cần xuất tr&igrave;nh CMND/CCCD/ Hộ chiếu, Số điện thoại.</li>\r\n</ul>\r\n\r\n<p><strong>C&aacute;c qui định kh&aacute;c:</strong></p>\r\n\r\n<ul>\r\n	<li>Kh&aacute;ch h&agrave;ng tr&uacute;ng thưởng thực hiện đ&uacute;ng theo quy định của ph&aacute;p luật về thuế thu nhập c&aacute; nh&acirc;n sau khi nhận giải, C&ocirc;ng ty TNHH Sơn Jotun Việt Nam sẽ thực hiện khấu trừ thuế thu nhập c&aacute; nh&acirc;n (thu hộ v&agrave; nộp thay) theo quy định nếu c&oacute; ph&aacute;t sinh, trước khi thực hiện trao giải thưởng cho Kh&aacute;ch h&agrave;ng.</li>\r\n	<li>Kh&aacute;ch h&agrave;ng tr&uacute;ng thưởng chịu mọi chi ph&iacute; ph&aacute;t sinh nếu c&oacute; li&ecirc;n quan đến việc nhận giải thưởng</li>\r\n	<li>Giải thưởng kh&ocirc;ng được quy đổi th&agrave;nh tiền mặt.</li>\r\n	<li>Với sự đồng &yacute; của kh&aacute;ch h&agrave;ng tr&uacute;ng thưởng, doanh nghiệp sẽ sử dụng th&ocirc;ng tin v&agrave; h&igrave;nh ảnh của người tr&uacute;ng thưởng v&agrave;o c&aacute;c hoạt động quảng c&aacute;o.</li>\r\n	<li>Mọi khiếu nại về chương tr&igrave;nh sau ng&agrave;y 20/11/2022 sẽ kh&ocirc;ng được giải quyết.</li>\r\n	<li>Doanh nghiệp sẽ c&oacute; tr&aacute;ch nhiệm lưu trữ bằng chứng tr&uacute;ng thưởng của người nhận giải thưởng phục vụ cho c&ocirc;ng t&aacute;c kiểm tra gi&aacute;m s&aacute;t theo quy định của ph&aacute;p luật.</li>\r\n</ul>', 'editor', 1, 1, NULL, 11, '');
...
CREATE TABLE `fs_groups_permission`  (
  ...
  `permission` int(11) NULL DEFAULT NULL COMMENT '3: view\r\n5: edit\r\n7: delete',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `fs_hits`  (
  ...
  `visited_time` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `fs_keywords_seo`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_content` int(11) NULL DEFAULT NULL,
  `module` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `fs_menus_admin`  (
  ...
  `admin_type` tinyint(4) NULL DEFAULT NULL COMMENT 'to used for Admin or User in back-end',
  `module` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `view` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `code_color` int(11) NULL DEFAULT 1,
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `fs_menus_admin` VALUES (33, 'Block', 'banner.png', NULL, 0, 1, 1, NULL, NULL, NULL, 'fa fa-star', NULL, 1);
INSERT INTO `fs_menus_admin` VALUES (35, 'Danh sách Block', NULL, 'index.php?module=block&view=block', 33, 1, 1, NULL, NULL, NULL, 'fa fa-star', NULL, 1);
...
CREATE TABLE `fs_translate_content`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `etemplate_id` int(11) NULL DEFAULT NULL,
  `published` tinyint(4) NULL DEFAULT NULL,
  `ordering` int(11) NULL DEFAULT NULL,
  `created_time` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `fs_users`  (
  ...
  `group_company` int(11) NOT NULL DEFAULT 0 COMMENT '0: Admin; 1: Tập đoàn; 2: Đơn vị',
  `position_group` int(11) NULL DEFAULT NULL,
...
-- Records of fs_users
-- ----------------------------
INSERT INTO `fs_users` VALUES (9, 'admin', 'ede6b50e7b5826fe48fc1f0fe772c48f', '', '', 'manhlinh@finalstyle.com', '0383760076', 'Tan trieu, thanh tri', 'Viet Nam', 1, 1, '2022-05-08 03:33:51', '2021-12-22 19:48:56', NULL, NULL, NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `fs_users_permission`  (
  ...
  `task_id` int(11) NULL DEFAULT NULL COMMENT 'Lấy id của permission_task',
